...
To keep track of if clients are already verified for a set amount of time previous so you don't have to verify them again

1. What does bcrypt do to help us store passwords in a secure manner.

It encrypts the password string multiple times

1. What does bcrypt do to slow down attackers?

It encrypts multiple times, set by an amount of time, to make it hard for hackers to know what the original password is
